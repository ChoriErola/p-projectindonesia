...
<head>
  ...
  <title>P Project Indonesia</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link rel="icon" href="{{ asset('images/android-projectindonesia.png')}}">
  <link rel="icon" href="{{ asset('images/apple-projectindonesia.png')}}">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="{{ '/' }}" class="logo d-flex align-items-center me-auto">
        <h1 class="sitename">P Project Indonesia</h1>
      </a>
  ...
  <main class="main">
    ...
    <section id="beranda" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center" style="position: relative; z-index: 10;">
        <h2 data-aos="fade-up" data-aos-delay="100">RENCANAKAN DAN WUJUDKAN</h2>
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          ...
          <div class="social-links d-flex mt-4">
            <a href="https://www.tiktok.com/@p_project.wo.eo" target="_blank"><i class="bi bi-tiktok"></i></a>
            <a href="https://www.youtube.com/@P.projectindonesia" target="_blank"><i class="bi bi-youtube"></i></a>
            <a href="https://www.instagram.com/p_projectindonesia/" target="_blank"><i class="bi bi-instagram"></i></a>
            <a href="https://wa.me/628117411190" target="_blank" rel="noopener"><i class="bi bi-whatsapp"></i></a>
          </div>
        </div>
